"""
A loss function and optimizer to perform stealthy model poisoning as proposed in https://arxiv.org/abs/1811.12470
"""
...
def loss(model, scale, loss, val_X, val_y):
    """
    Loss function for stealthy model poisoning https://arxiv.org/abs/1811.12470
